...
(
	...
	FOREIGN KEY (movieId) REFERENCES movies ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (genreId) REFERENCES genre ON UPDATE CASCADE ON DELETE CASCADE,
...
(
	...
	FOREIGN KEY (movieId) REFERENCES movies ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (actorId) REFERENCES actors ON UPDATE CASCADE ON DELETE CASCADE,
)
